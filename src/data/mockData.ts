...
export const petTypes = ["Perro", "Gato", "Ave", "Conejo", "Pece", "Hamster"];
...
export const mockReviews: Review[] = [
  {
    ...
    userAvatar:
      "https://images.unsplash.com/photo-1494790108755-2616b612b15c?w=60&h=60&fit=crop&crop=face",
    rating: 5,
...
const getRandomCertifications = () => {
  ...
  const numberOfCertifications = faker.number.int({
    min: 0,
    max: certifications.length,
  });
...
export const mockHosts: Host[] = [
  ...
  },
  {
    ...
    description:
      "Clínica veterinaria con servicios de consulta, vacunación, cirugía y estética canina y felina.",
  ...
  },
  {
    ...
    description:
      "Hospital veterinario con atención las 24 horas, servicio de urgencias, laboratorio y hospitalización.",
    services: [
      "Urgencias 24h",
      "Hospitalización",
      "Laboratorio",
  ...
  },
  {
    ...
    description:
      "Clínica veterinaria con enfoque en medicina preventiva, planes de salud y nutrición para mascotas.",
    services: [
      "Medicina preventiva",
      "Planes de salud",
      "Nutrición",
  ...
  },
  {
    ...
    description:
      "Centro de cuidado integral para mascotas con servicios de veterinaria, estética, pensión y adiestramiento.",
    services: [
      "Veterinaria",
      "Estética",
      "Pensión",
  ...
  },
  {
    ...
    description:
      "Unidad veterinaria con servicios de consulta, desparasitación, esterilización y venta de alimentos y accesorios.",
    services: [
      "Consulta",
      "Desparasitación",
      "Esterilización",
  ...
  },
  {
    ...
    description:
      "Hospital veterinario de alta especialidad con tecnología de vanguardia y atención 24/7. Especialistas en cirugía, cardiología y oncología veterinaria.",
    services: [
  ...
  },
  {
    ...
    description:
      "Clínica veterinaria familiar con más de 20 años de experiencia. Ofrecemos servicios integrales de medicina preventiva y curativa.",
    services: [
      "Consulta general",
      "Vacunación",
      "Esterilización",
  ...
  },
  {
    ...
    description:
      "Centro veterinario moderno especializado en medicina de animales exóticos y mascotas tradicionales. Instalaciones de lujo con personal bilingüe.",
    services: [
      "Medicina exótica",
      "Hospitalización",
      "Grooming",
  ...
  },
  {
    ...
    description:
      "Hospital veterinario regional con equipo médico especializado y tecnología avanzada. Referente en el norte del país para casos complejos.",
    services: [
      "Neurología",
      "Oftalmología",
      "Dermatología",
  ...
  },
  {
    ...
    description:
      "Clínica veterinaria de tradición familiar que brinda atención personalizada y cálida. Especializada en medicina preventiva y cuidados básicos.",
    services: [
      "Consulta general",
      "Vacunación",
      "Desparasitación",
  ...
  },
  {
    ...
    description:
      "Centro de alta especialidad veterinaria con las últimas tecnologías en diagnóstico y tratamiento. Referencia nacional en medicina veterinaria.",
    services: [
